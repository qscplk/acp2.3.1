...
// SetEnableAnonymous 'enable-anonymous' argument of Dashboard binary.
func (self *holderBuilder) SetEnableAnonymous(enableAnonymous bool) *holderBuilder {
	self.holder.enableAnonymous = enableAnonymous
	return self
}

func (self *holderBuilder) SetMultiClusterHost(multiclusterhost string) *holderBuilder {
	self.holder.multiClusterHost = multiclusterhost
	return self
}
