...
var (
	requestCounter = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "diable_apiserver_request_count",
			Help: "Counter of diable apiserver requests broken out for each verb, API resource, client, and HTTP response contentType and code.",
		},
		[]string{"verb", "resource", "client", "contentType", "code"},
	)
	requestLatencies = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name: "diable_apiserver_request_latencies",
	...
	requestLatenciesSummary = prometheus.NewSummaryVec(
		prometheus.SummaryOpts{
			Name: "diable_apiserver_request_latencies_summary",
