...
import (
	...
	errorHandler "alauda.io/diablo/src/backend/errors"
	metricapi "alauda.io/diablo/src/backend/integration/metric/api"
	"alauda.io/diablo/src/backend/resource/common"
	"alauda.io/diablo/src/backend/resource/controller"
...
func GetPodDetail(client kubernetes.Interface, metricClient metricapi.MetricClient, namespace, name string) (
	*PodDetail, error) {
	...
	pod, err := client.CoreV1().Pods(namespace).Get(name, api.GetOptionsInCache)
	if err != nil {
		return nil, err
	}
...
func evalValueFrom(src *v1.EnvVarSource, container *v1.Container, pod *v1.Pod,
	...
	case src.FieldRef != nil:
		gvk := schema.GroupVersionKind{Version: src.FieldRef.APIVersion, Kind: "Pod"}
