...
import (
	...
	"alauda.io/diablo/src/backend/resource/limitrange"
	rq "alauda.io/diablo/src/backend/resource/resourcequota"
	"k8s.io/api/core/v1"
...
func GetNamespaceDetail(client k8sClient.Interface, name string) (*NamespaceDetail, error) {
	...
	namespace, err := client.CoreV1().Namespaces().Get(name, api.GetOptionsInCache)
	if err != nil {
		return nil, err
	}
